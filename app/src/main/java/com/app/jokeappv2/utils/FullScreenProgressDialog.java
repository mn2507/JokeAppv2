package com.app.jokeappv2.utils;
 ...
 */public class FullScreenProgressDialog extends Dialog {
    ...
    public FullScreenProgressDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
        ...
        progressBar.getIndeterminateDrawable().setColorFilter(ContextCompat.getColor(context, R.color.white), android.graphics.PorterDuff.Mode.MULTIPLY);
